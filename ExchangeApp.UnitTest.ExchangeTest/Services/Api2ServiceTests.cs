...
namespace ExchangeApp.UnitTest.ExchangeTest.Services
{
    public class Api2ServiceTests
    {
        ...
        {
            // Logger mock
            var loggerMock = new Mock<ILogger<Api2Service>>();
            _service = new Api2Service(loggerMock.Object);
        }

        /// <summary>
        /// 1. Verifica que la conversión de USD a DOP devuelva el monto convertido correctamente según las tasas de API2.
        /// </summary>
        [Fact]
        public void Convert_ShouldReturnConvertedAmount_WhenUsdToDop()
        {
            ...
            result.Value.Total.Should().Be(605.00m);
        }

        /// <summary>
        /// 2. Verifica que la conversión falle cuando se usan monedas no soportadas.
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// 3. Verifica que la conversión de DOP a USD devuelva el monto correcto según la tasa de API2.
        /// </summary>
        [Fact]
        public void Convert_ShouldReturnConvertedAmount_WhenDopToUsd()
        {
            ...
            result.IsSuccess.Should().BeTrue();
            result.Value.Total.Should().Be(10.00m);
        }

        /// <summary>
        /// 4. Verifica que la conversión de EUR a DOP devuelva el monto correcto según la tasa de API2.
        /// </summary>
        [Fact]
        public void Convert_ShouldReturnConvertedAmount_WhenEurToDop()
        {
            ...
            result.IsSuccess.Should().BeTrue();
            result.Value.Total.Should().Be(128.00m);
        }

        /// <summary>
        /// 5. Verifica que si la moneda de origen y destino son iguales, se devuelva el mismo monto.
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// 6. Verifica que los códigos de moneda sean tratados sin distinguir mayúsculas/minúsculas.
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// 7. Verifica que la conversión falle cuando ambas monedas no están soportadas.
        /// </summary>
        [Fact]
